...
@c.option(
    "--paint/--no-paint", "draw_paint", help="Draw painted blocks with the paint color overlayed on them.", default=True
)
...
@c.option(
    "-w", "--region_width", "region_width", type=int, help="Width of region for custom world rendering", default=None
)
@c.option(
    "-h", "--region_height", "region_height", type=int, help="Height of region for custom world rendering", default=None
)
def flyingsnake(
    input_file: str,
    output_file: str,
    ...
    min_x, min_y, max_x, max_y = get_region_size(
