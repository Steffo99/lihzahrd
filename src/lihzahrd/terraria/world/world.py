...
class World:
    ...
    def _read_tile_block(fr: FilePacker, tileframeimportant) -> tuple[Tile, int]:
        flags1 = fr.read_bits()
        has_flags2 = flags1[0]
        flags2 = fr.read_bits() if has_flags2 else FilePacker.BITS[0]
        has_flags3 = flags2[0]
        flags3 = fr.read_bits() if has_flags3 else FilePacker.BITS[0]
        has_flags4 = flags3[0]
        flags4 = fr.read_bits() if has_flags4 else FilePacker.BITS[0]
